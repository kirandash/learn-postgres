...
INSERT INTO
	small_integer_example (username, age, otp, zipCode, phoneNumber, savings)
VALUES
	...
	('mark_taylor', 50, 7890, 10001, 543210987654321, 150000);

-- An older person in New York
SELECT
	*
FROM
	small_integer_example;